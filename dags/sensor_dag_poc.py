...
def process_trailer_info(**context):
    ...
    # Push the trailer_info to XCom
    context['ti'].xcom_push(key='trailer_info', value=trailer_info)

with DAG(
    'gcs_to_bigquery_with_archive',
    ...
    # Task to move processed CSV to archival folder
    ...
    check_for_new_file >> extract_trailer >> load_to_bigquery >> move_to_archival >> delete_original_file
